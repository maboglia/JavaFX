 ...
 * @author teacher
 */
public class Prj_05_Lampadina extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Image lamp_on = new Image("img/accesa.jpg");
        Image lamp_off = new Image("img/spenta.jpg");
